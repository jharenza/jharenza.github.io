---
title: "Explore medulloblastoma subtype calls in the context of unsupervised clustering"
...
mm2s_file <- file.path(data_dir, "rathi_results.tsv")
```
## Read in files
```{r}
# PBTA
...
pbta_combined_subtypes <- read.delim(mm2s_file, sep = "\t", header = T)
...
```  
## Does this data look better? (Yes)
```{r}
umap_plot_df %>%
  ggplot(aes(x = X1, 
             y = X2,
